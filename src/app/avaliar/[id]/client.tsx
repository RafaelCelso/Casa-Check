...
export default function AvaliarClient({ id }: { id: string }) {
  ...
  const handleSubmit = async () => {
    ...
    const avaliacoes: Record<
      string,
      { rating: number; comentario: string; data: string }
    ...
    window.location.href = `/avaliar/${id}/sucesso`;
  };
